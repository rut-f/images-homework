...
# ==============================
# יצירת תמונה עם ניגוד נמוך
# ==============================
low_contrast_img = create_low_contrast_image(300, 500, fg=100, bg=105)

# ==============================
# שינוי פיקסלים קיצוניים לשאלה 6
# ==============================
low_contrast_img[0, 0] = 0       # פיקסל ראשון = 0
low_contrast_img[-1, -1] = 255   # פיקסל אחרון = 255
print("\nAfter modifying two pixels:")
...
plt.subplot(1,2,1)
plt.title("Low Contrast Image (with modified pixels)")
